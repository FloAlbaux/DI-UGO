 ...
 */
final class Version20231111164805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, title, lastname, firstname, postalcode, city, email FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER NOT NULL, title INTEGER NOT NULL, lastname VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, postalcode INTEGER DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO customer (id, title, lastname, firstname, postalcode, city, email) SELECT id, title, lastname, firstname, postalcode, city, email FROM __temp__customer');
        ...
        $this->addSql('CREATE TABLE purchases (id INTEGER NOT NULL, customer_id INTEGER DEFAULT NULL, purchase_identifier VARCHAR(255) NOT NULL, quantity INTEGER NOT NULL, price INTEGER NOT NULL, currency VARCHAR(255) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_AA6431FE9395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
